  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (mode === 'register') {
        ...
        // Register in Supabase customers table
        ...
        fireToast(`Welcome back, ${data.full_name}! 👋`, 'success');
        onLoginSuccess(data);
      }
    } catch (err: any) {
  ...
  return (
    <div className="fixed inset-0 z-[10000] bg-slate-950/70 backdrop-blur-md flex items-center justify-center p-4 animate-fadeIn">
      ...
      >
        ...
        <div className="h-1.5 w-full bg-gradient-to-r from-[#3C6CA8] via-blue-500 to-indigo-600" />
        ...
        <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-slate-100 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl overflow-hidden ring-2 ring-[#3C6CA8]/20 dark:ring-blue-400/30 flex-shrink-0 shadow-sm">
          ...
          <button
            onClick={onClose}
            className="w-9 h-9 rounded-full bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-500 dark:text-slate-300 flex items-center justify-center transition-colors cursor-pointer"
        ...
        <form onSubmit={handleAuth} className="p-6 space-y-4 text-left">
          {mode === 'register' && (
            <div className="bg-gradient-to-br from-blue-50/90 via-slate-50/50 to-indigo-50/60 dark:from-slate-950 dark:to-blue-950/40 border border-blue-100 dark:border-blue-900/30 rounded-2xl p-4 mb-3 text-xs space-y-2.5 shadow-2xs">
          ...
          {mode === 'register' ? (
            <>
              <div>
                <label htmlFor="register-fullName" className="flex items-center gap-1.5 text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-1.5">
                  <User className="w-3.5 h-3.5 text-[#3C6CA8] dark:text-blue-400" /> Full Name
                </label>
                <div className="relative">
                  <div className="absolute left-3 top-1/2 transform -translate-y-1/2 w-7 h-7 rounded-lg bg-blue-50 dark:bg-blue-950/50 flex items-center justify-center border border-blue-100 dark:border-blue-900/40">
                    <User className="text-[#3C6CA8] dark:text-blue-400 w-3.5 h-3.5" />
                  </div>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label htmlFor="register-email" className="flex items-center gap-1.5 text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-1.5">
                    <Mail className="w-3.5 h-3.5 text-[#3C6CA8] dark:text-blue-400" /> Email Address
                  </label>
                  <div className="relative">
                    <div className="absolute left-3 top-1/2 transform -translate-y-1/2 w-7 h-7 rounded-lg bg-blue-50 dark:bg-blue-950/50 flex items-center justify-center border border-blue-100 dark:border-blue-900/40">
                      <Mail className="text-[#3C6CA8] dark:text-blue-400 w-3.5 h-3.5" />
                    </div>
                    <input
                      type="email"
                      id="register-email"
                ...
                <div>
                  ...
                  <div className="relative">
                    <div className="absolute left-3 top-1/2 transform -translate-y-1/2 w-7 h-7 rounded-lg bg-indigo-50 dark:bg-indigo-950/50 flex items-center justify-center border border-indigo-100 dark:border-indigo-900/40">
                      <Phone className="text-indigo-500 dark:text-indigo-400 w-3.5 h-3.5" />
                    </div>
                    <input
                      type="tel"
                      id="register-phone"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label htmlFor="register-password" className="flex items-center gap-1.5 text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-1.5">
                    <Lock className="w-3.5 h-3.5 text-purple-500 dark:text-purple-400" /> Password
                  </label>
                  <div className="relative">
                    <div className="absolute left-3 top-1/2 transform -translate-y-1/2 w-7 h-7 rounded-lg bg-purple-50 dark:bg-purple-950/50 flex items-center justify-center border border-purple-100 dark:border-purple-900/40">
                      <Lock className="text-purple-500 dark:text-purple-400 w-3.5 h-3.5" />
                    </div>
                    <input
                ...
                <div>
                  <label htmlFor="register-confirmPassword" className="flex items-center gap-1.5 text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-1.5">
                    <KeyRound className="w-3.5 h-3.5 text-emerald-500 dark:text-emerald-400" /> Confirm Password
                  </label>
                  <div className="relative">
                    <div className="absolute left-3 top-1/2 transform -translate-y-1/2 w-7 h-7 rounded-lg bg-emerald-50 dark:bg-emerald-950/50 flex items-center justify-center border border-emerald-100 dark:border-emerald-900/40">
                      <KeyRound className="text-emerald-500 dark:text-emerald-400 w-3.5 h-3.5" />
                    </div>
                    <input
                      type={showPassword ? 'text' : 'password'}
            ...
            <>
              <div>
                ...
                <div className="relative">
                  <div className="absolute left-3 top-1/2 transform -translate-y-1/2 w-7.5 h-7.5 rounded-xl bg-blue-50 dark:bg-blue-950/50 flex items-center justify-center border border-blue-100 dark:border-blue-900/40">
                    <Mail className="text-[#3C6CA8] dark:text-blue-400 w-4 h-4" />
                  </div>
                  <input
                    type="email"
                    id="login-email"
              ...
              <div>
                <label htmlFor="login-password" className="flex items-center gap-1.5 text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-1.5">
                  <Lock className="w-3.5 h-3.5 text-indigo-500 dark:text-indigo-400" /> Password
                </label>
                <div className="relative">
                  <div className="absolute left-3 top-1/2 transform -translate-y-1/2 w-7.5 h-7.5 rounded-xl bg-indigo-50 dark:bg-indigo-950/50 flex items-center justify-center border border-indigo-100 dark:border-indigo-900/40">
                    <Lock className="text-indigo-500 dark:text-indigo-400 w-4 h-4" />
                  </div>
                  <input
                    type={showPassword ? 'text' : 'password'}
                    id="login-password"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 px-6 bg-gradient-to-r from-[#3C6CA8] via-blue-600 to-[#2A5288] hover:from-blue-600 hover:to-[#1E3E68] text-white rounded-2xl font-extrabold text-sm shadow-md hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 mt-4 group"
          >
            {loading ? (
              <>
          ...
          {/* ⚡ One-Click Demo Account Quick Fill Button */}
          <div className="pt-1">
            <button
              type="button"
              onClick={() => {
                const demoCustomer = {
                  id: 'demo-customer-999',
                  full_name: 'Dr. Sarah Jenkins (Demo)',
                  email: 'sarah.jenkins@biotech-research.org',
                  phone: '0917-555-8899',
                  created_at: new Date().toISOString()
                };
                fireToast('Logged in with Demo Account! 🧪', 'success');
                onLoginSuccess(demoCustomer);
              }}
              className="w-full py-2.5 px-4 rounded-xl bg-gradient-to-r from-emerald-500/10 via-teal-500/15 to-emerald-500/10 hover:from-emerald-500/20 hover:to-teal-500/25 border border-emerald-500/30 text-emerald-700 dark:text-emerald-300 font-extrabold text-xs transition-all flex items-center justify-center gap-2 cursor-pointer shadow-2xs group"
            >
          ...
          <div className="pt-1 text-center">
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200/80 dark:bg-slate-800 dark:hover:bg-slate-700 text-xs font-extrabold text-[#3C6CA8] dark:text-blue-300 transition-all cursor-pointer"
            >
